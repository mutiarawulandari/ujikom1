...
<head>
    <meta charset="UTF-8">
    <title>Manajemen Tarif Rental</title>
...
<body>
    <!-- Navbar -->
    <nav class="navbar">
        <h2><i class="fas fa-money-bill-wave"></i> Manajemen Tarif Rental</h2>
    ...
    <div class="main-content">
        <div class="header">
            <h2>Manajemen Tarif Rental</h2>
            <div class="action-buttons">
                <a href="create.php" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah Tarif</a>
                <a href="../dashboard.php" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Kembali ke Dashboard</a>
            </div>
        </div>

        <div class="card">
            <h3><i class="fas fa-table"></i> Data Tarif Rental</h3>
            <table>
                <tr>
                    <th>ID</th>
                    <th>Motor</th>
                ...
                <tr>
                    ...
                    <td>
                        <div class="action-buttons-cell">
                            ...
                            <a href="delete.php?id=<?= $row['id'] ?>" class="btn btn-danger" onclick="return confirm('Yakin hapus tarif ini?')">
