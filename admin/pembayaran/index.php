...
<body>
    <!-- Navbar -->
    <nav class="navbar">
        <h2><i class="fas fa-money-check-alt"></i> Konfirmasi Pembayaran</h2>
    ...
    <div class="sidebar" id="sidebar">
        <ul>
            ...
            <li><a href="index.php" class="active"><i class="fas fa-credit-card"></i> Pembayaran</a></li>
    ...
    <div class="main-content">
        ...
        <div class="card">
            <h3><i class="fas fa-money-check-alt"></i> Daftar Pembayaran</h3>
            <table>
                <tr>
                    <th>ID</th>
                    <th>Penyewa</th>
                ...
                <?php 
                $resPembayaran = mysqli_query($conn, "
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if ($row['status'] == 'pending') { ?>
                                <a href="konfirmasi_pembayaran.php?id=<?= $row['id'] ?>" 
